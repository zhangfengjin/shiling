            ...
            if (validateWords) {
                ...
                var wordsLength = function (len) {
                    /*for( var w = words.length; w--; )
                     ...
                     return false;*/
                    //modify by fengjin1 2017-2-16 为什么还要限制每个字段的长度？？？
                    return true;
                };
                ...
                //return true; modify  by fengjin1 2016-2-16 验证规则通过后应该继续验证其他规则而不应该退出
            }
            skip = false;//add by fengjin1 2017-2-16 传递的skip永远为true 不可能运行此代码
